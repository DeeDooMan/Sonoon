    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a href="foods.html" class="nav-link">Еда</a></li>
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                ...
                <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Домой <i class="ion-ios-arrow-forward"></i></a></span> <span>Еда <i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-md-4 ftco-animate">
                        <div class="blog-entry">
                            ...
                            <div class="text pt-3">
                                <p class="meta d-flex"><span class="pr-3">Десерт</span><span class="ml-auto pl-3">Март 01, 2018</span></p>
            ...
            <div class="col-lg-3">
                <div class="sidebar-wrap">
                    <div class="sidebar-box p-4 about text-center ftco-animate">
                        ...
                        <div class="text pt-4">
                            <p>Привет! Меня зовут <strong>Cathy Deon</strong>, за горами слова, вдали от стран вокалии и консонантии, живут слепые тексты. Отдельно они живут в Закладочной роще прямо на берегу Семантики, большого языкового океана..</p>
                        </div>
                    </div>
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <p>Далеко-далеко, за словом горы, далеко от стран Вокалия и Консонантия, живут слепые тексты..</p>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-5">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="#" class="py-2 d-block">Условия использования</a></li>
                        <li><a href="#" class="py-2 d-block">О рассказахs</a></li>
                        <li><a href="#" class="py-2 d-block">Политика конфиденциальности</a></li>
                        <li><a href="#" class="py-2 d-block">Справка по доступности</a></li>
                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">+996 501 043212</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">inai.kg</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> Все права защищены | Этот шаблон сделан с <i class="icon-heart color-danger" aria-hidden="true"></i>  <a href="https://colorlib.com" target="_blank">Colorlib</a>
