      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h1 class="mb-3 bread">Мертвое озеро</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 order-lg-last ftco-animate">
            <h2 class="mb-3">Мертвое озеро под Бишкеком манит сотни туристов. Но дойти туда может не каждый</h2>
             <p>В двух часах езды от Бишкека находится урочище Кол-Тор — небольшое "ответвление" от ущелья Кегети. Оно богато красивыми пейзажами и чистыми горными реками.</p>

            <p>
              <img src="/static/images/bg_5.jpg" alt="" class="img-fluid">
            </p>
            <p>Словно магнит, притягивает туристов озеро Кол-Тор, которое находится в природном заповеднике. Его называют мертвым: хотя водоем пресный, в нем ничего не растет и нет рыбы. Озеро находится на высоте 2700 метров.
Длина пешеходного трека сюда — 8 километров в одну сторону. На протяжении всего пути приходится идти в гору, такое испытание под силу далеко не каждому. Среднее время похода в одну сторону — 3-4 часа.
